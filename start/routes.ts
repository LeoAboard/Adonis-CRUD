...
Route.post("/lista", "ListasController.create")
Route.get("/lista", "ListasController.exibir")
Route.put("/lista", "ListasController.atualizar")
Route.delete("/lista", "ListasController.excluir")